...
describe('Thresholder class', () => {
  ...
  describe('constructor', () => {
    it('should create a valid instance with default settings', () => {
      const t = new Thresholder();
      expect(t).toBeDefined();
    });
    it('should throw exception when boundary is specified but operator is not', () => {
      expect(() => { new Thresholder<number>(3, 5, 60, 60) }).toThrowError();
    });
  });
